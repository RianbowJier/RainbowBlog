package com.example.framework.handler.mybatisplus;
 ...
 * (原因是前端在发送评论时，没有在 请求体提供下面四个参数，所以后端在往数据库插入数据时，下面四个字段是空值)，所有就需要这个类来帮助我们往下面这四个字段自动的插入值，
 * 只要我们更新了评论表的字段，那么无法插入值的字段就自动有值了
 *
 * @Author:Rainbow
 * @CreateTime:2023/12/1921:33
 */
@Component
